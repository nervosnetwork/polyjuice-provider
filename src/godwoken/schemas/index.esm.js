(function (global, factory) {
  ...
  function SerializeWithdrawalRequestVec(value) {
    return serializeTable(
      value.map((item) => SerializeWithdrawalRequest(item))
    );
  }
  ...
  class VerifyTransactionSignatureWitness {
    ...
    validate(compatible = false) {
      ...
      new VerifyTransactionSignatureContext(
    ...
    getContext() {
      ...
      const offset = this.view.getUint32(start, true);
      const offset_end = this.view.byteLength;
      return new VerifyTransactionSignatureContext(
        this.view.buffer.slice(offset, offset_end),
        { validate: false }
      );
    }
  ...
  exports.SerializeVerifyTransactionSignatureContext =
    SerializeVerifyTransactionSignatureContext;
