...
export function SerializeByteOpt(value) {
  if (value) {
...
export function SerializeAbiInput(value) {
  const buffers = [];
...
export function SerializeAbiOutput(value) {
  const buffers = [];
  buffers.push(SerializeBytes(value.name));
  buffers.push(SerializeBytes(value.type));
  buffers.push(SerializeBytesOpt(value.components));
...
export function SerializeAbiInputs(value) {
...
export function SerializeAbiOutputs(value) {
...
export function SerializeAbiInputsOpt(value) {
  if (value) {
...
export function SerializeAbiOutputsOpt(value) {
  if (value) {
...
export function SerializeAbiItem(value) {
  const buffers = [];
