...
const { PolyjuiceJsonRpcProvider } = require("../lib/index");
const { PolyjuiceWallet } = require("../lib/index");

console.log(PolyjuiceWallet)
console.log(PolyjuiceJsonRpcProvider)
